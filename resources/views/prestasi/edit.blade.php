                        ...
                        <div class="card-body pb-0">
                           <div class="form-group">
                              ...
                              <input type="text" class="form-control @error('nama') is-invalid @enderror" id="nama"
                                 name="nama" placeholder="Masukkan nama lomba" value="{{ old('nama', $prestasi->nama) }}"
                                 autofocus>
                              @error('nama')
                           ...
                           <div class="form-group">
                              ...
                              <input type="text" class="form-control @error('tingkat') is-invalid @enderror" id="tingkat"
                                 name="tingkat" placeholder="Masukkan tingkat lomba"
                           ...
                           <div class="form-group">
                              ...
                              <input type="text" class="form-control @error('capaian') is-invalid @enderror" id="capaian"
                                 name="capaian" placeholder="Masukkan capaian prestasi"
                           ...
                           <div class="form-group">
                              ...
                              <input type="date" class="form-control @error('tanggal') is-invalid @enderror" id="tanggal"
                                 name="tanggal" placeholder="Masukkan tanggal pelaksanaan"
