                     ...
                     <form method="POST" action="/siswa/{{ $siswa->id }}" enctype="multipart/form-data">
                        ...
                        <div class="card-body pb-0">
                              ...
                              <div class="col-sm-6">
                                 <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('nama') is-invalid @enderror"
                                       ...
                                       value="{{ old('nama', $siswa->nama) }}" autofocus>
                                    @error('nama')
                              ...
                              <div class="col-sm-6">
                                 <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('nis') is-invalid @enderror"
                                       id="nis" name="nis" placeholder="Masukkan nis siswa"
                              ...
                              <div class="col-sm-6">
                                 <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('nisn') is-invalid @enderror"
                                       id="nisn" name="nisn" placeholder="Masukkan nisn siswa"
                           ...
                           <div class="form-group row mb-3">
                              ...
                              <label id="label_jumlah_prestasi" for="jumlah_prestasi"
                                 class="col-form-label pr-0 mx-2 mr-3" hidden>Jumlah</label>
                           ...
                           <div class="form-group">
                              ...
                              <input type="text" class="form-control @error('tempat_tinggal') is-invalid @enderror"
                                 id="tempat_tinggal" name="tempat_tinggal" placeholder="Masukkan alamat siswa"
