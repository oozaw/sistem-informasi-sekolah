                  ...
                  <div class="card">
                     ...
                     <div class="card-body">
                        <div class="form-group row mb-3">
                           ...
                           <div class="col-2 pl-0 mr-3">
                              <select class="form-control" name="kelas" id="kelas" onchange="komite()" required>
                        ...
                        <div class="row" id="data">
                           ...
                           <a href="/komite-simpan" class="btn btn-primary ml-auto mr-4">Simpan</a>
                        </div>
                     </div>
                     <!-- /.card-body -->
                  </div>
