...
(function ($) {
    ...
    var relToAbs = function (el) {
        ...
        if (clone.nodeName.toLowerCase() === "link") {
            ...
            if (
                linkHost.indexOf("/") === -1 &&
                link.pathname.indexOf("/") !== 0
            ) {
                linkHost += "/";
            }
            clone.href =
                link.protocol + "//" + linkHost + link.pathname + link.search;
        }
...
<style>';
            if (settings.orientation == "potrait") {
                ...
                templateHeader +=
                    "<!--@page WordSection1 {size:792.0pt 612.0pt; mso-page-orientation:landscape; margin:90.0pt 72.0pt 90.0pt 72.0pt; mso-header-margin:35.4pt; mso-footer-margin:35.4pt; mso-paper-source:0;}div.WordSection1 {page:WordSection1;}-->";
            }
            templateHeader +=
                "</style></head><body bgcolor=white lang=EN-US style='tab-interval:36.0pt'><p>" +
                settings.message +
                "</p><div class=WordSection1>";
            var templateFooter =
                "<p class=MsoNormal style='mso-margin-top-alt:auto;mso-margin-bottom-alt:auto'><span style='mso-fareast-font-family:\"Times New Roman\";mso-bidi-font-family:\"Times New Roman\"'><o:p>&nbsp;</o:p></span></p></div><p>" +
                settings.message +
                "</p></body></html>";
            var thead = "<thead>";
            thead += "<tr>";
            ...
            saveAs(
                new Blob(["\ufeff", templateHeader + output + templateFooter], {
...
tbody tr:nth-child(odd) {\
  background: #eee;\
            ...
            var output =
                ...
                "</h1></center>" +
                (settings.message != ""
                    ? "<center><p>" + settings.message + "</p></center>"
                    : "") +
                table;
